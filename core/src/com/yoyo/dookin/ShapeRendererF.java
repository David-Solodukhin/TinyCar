 ...
 * 
 * ShapeRendererF.begin(ShapeType.Line);
 * ShapeRendererF.setColor(1, 1, 0, 1);
 * ShapeRendererF.line(x, y, x2, y2);
 * ShapeRendererF.rect(x, y, width, height);
 * ShapeRendererF.circle(x, y, radius);
 * ShapeRendererF.end();
 * 
 * ShapeRendererF.begin(ShapeType.Filled);
 * ShapeRendererF.setColor(0, 1, 0, 1);
 * ShapeRendererF.rect(x, y, width, height);
 * ShapeRendererF.circle(x, y, radius);
 * ShapeRendererF.end();
 * }
 * </pre>
 * 
 * ShapeRendererF has a second matrix called the transformation matrix which is used to rotate, scale and translate shapes in a
 ...
 * <pre>
 * ShapeRendererF.begin(ShapeType.Line);
 * ShapeRendererF.identity();
 * ShapeRendererF.translate(20, 12, 2);
 * ShapeRendererF.rotate(0, 0, 1, 90);
 * ShapeRendererF.rect(-width / 2, -height / 2, width, height);
 * ShapeRendererF.end();
 * </pre>
 * 
 ...
 * <p>
 * The projection and transformation matrices are a state of the ShapeRendererF, just like the color, and will be applied to all
 * shapes until they are changed.
 * @author mzechner
 * @author stbachmann
 * @author Nathan Sweet */
public class ShapeRendererF implements Disposable {
	...
	private float defaultRectLineWidth2 = 0.28f;

	public ShapeRendererF () {
		this(5000);
	}

	public ShapeRendererF (int maxVertices) {
	...
	public void line (float x, float y, float z, float x2, float y2, float z2, Color c1, Color c2) {
		if (shapeType == ShapeType.Filled) {
			rectLine(x, y, x2, y2, defaultRectLineWidth2);
			return;
		}
